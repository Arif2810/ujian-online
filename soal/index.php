                ...
                <?php 
                  ...
                  while($soal = mysqli_fetch_assoc($querySoal)){ ?>
                    <tr>
                      ...
                      <td style="width: 10%">
                        <a href="#" title="view soal" onclick="window.open('view-soal.php?id=<?= $soal['id'] ?>', '', 'width=800, height=450, top=80, left=120')" class="btn btn-primary btn-xs">
                          <i class="ti-eye"></i>
                        </a>
                        <a href="edit-soal.php?id=<?= $soal['id'] ?>" title="update soal" class="btn btn-warning btn-xs"><i class="ti-pencil-alt"></i></a>
                        <a href="proses-soal.php?id=<?= $soal['id'] ?>&gbr=<?= $soal['gambar'] ?>&op=delete" onclick="return confirm('Yakin hapus?')" title="delete soal" class="btn btn-danger btn-xs"><i class="ti-trash"></i></a>
                      </td>
                    </tr>
