...
<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
  ...
  <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
    ...
    <?php } 
        ...
        <a class="navbar-brand brand-logo me-5 text-secondary fs-3" href="#">Ujian Online</a>
    <?php } ?>
    <ul class="navbar-nav navbar-nav-right" id="nav_user">
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" id="profileDropdown">
          <?= 'Selamat datang <b>' .$_SESSION['ssFull']. '</b>'; ?>
        </a>
        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
          ...
          <a class="dropdown-item" href="<?= $mainUrl ?>autentikasi/logout.php">
    ...
    <ul class="navbar-nav navbar-nav-right visually-hidden" id="nav_ujian">
      <li class="nav-item dropdown">
        ...
        <button type="button" class="btn btn-outline-danger btn-xs fs-6" id="sisa"><?= durasi($ujian['waktu']) ?></button>
      </li>
    </ul>
